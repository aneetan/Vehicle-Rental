                    ...
                    <form className=" md:flex justify-between grid-cols-1 space-y-4 mx-12 md:mx-12">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute inset-y-0 left-0 pl-3 pb-[-10px] flex items-center pointer-events-none">
                        ...
                        <div>
                            <label className="block text-gray-700 mb-2 font-medium text-sm">Pick-up date</label>
                            <input 
                            type="datetime-local" 
                        ...
                        <div>
                            <label className="block text-gray-700 mb-2 font-medium text-sm">Return date</label>
                            <input 
                            type="datetime-local" 
                        ...
                        <div className="flex items-center">
                            <button 
                            type="submit"
                            className="w-full bg-[var(--primary-color)] hover:bg-[var(--primary-color-hover)] text-white mt-2 font-semibold py-2 px-4 rounded-lg transition duration-200"
                            >
                            Search
                            </button>
                        </div>
